...
if st.button("Calcular"):
    ...
    x_vals = np.linspace(dx1 + dx3, dx1 + dx3 + 5, 100)  # Ajustamos el rango de x
    y_vals = m1 * (x_vals - dx1 - dx3) + dy1 + dy3  # Ajustamos la fórmula para pasar por el punto final del azimut 1
